...
public class MyFragment1 extends BaseFragment {
    ...
    protected void setUpData() {
        ...
        mData.add(new com.example.hh.view7.bean.Icon(R.mipmap.q7,"语音识别AI开放平台","http://ai.baidu.com/tech/speech"));
        ...
        mData.add(new com.example.hh.view7.bean.Icon(R.mipmap.q3,"AliGenie语音开发者平台","https://open.bot.tmall.com/"));
